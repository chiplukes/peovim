...
def _make_catppuccin() -> Theme:
    ...
    g["constant"] = Style(fg=sapphire, attrs=ATTR_BOLD)
    g["constant.builtin"] = Style(fg=peach)
    g["constant.macro"] = Style(fg=sapphire, attrs=ATTR_BOLD)
...
def _make_gruvbox() -> Theme:
    ...
    g["constant"] = Style(fg=bright_blue, attrs=ATTR_BOLD)
...
def _make_onedark() -> Theme:
    ...
    g["constant"] = Style(fg=blue, attrs=ATTR_BOLD)
